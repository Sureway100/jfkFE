    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        <div style={styles.buttonContainer}>
          ...
          <button style={styles.button} onClick={() => navigate("/biodata")}>
            View or Submit Biodata
          </button>
          <button style={styles.button} onClick={() => navigate("/neworders")}>
            Create New Order
          </button>
          ...
          <button style={styles.button} onClick={handleMeasurementCheck}>
            View or Update Measurements
          </button>
